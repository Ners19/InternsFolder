...
<body>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <div style="display: flex; gap: 10px;">
                            <select name="business_nature" id="business_nature" style="flex: 1; padding: 8px;" onchange="toggleOtherBusinessNature()">
                            ...
                            <input type="text" name="business_nature_other" id="business_nature_other" placeholder="Specify if Other" style="flex: 1; padding: 8px; display: none;">
                        </div>
                    </td>
                </tr>
                <tr>
    ...
    function toggleOtherBusinessNature() {
        const businessNatureSelect = document.getElementById('business_nature');
        const otherInput = document.getElementById('business_nature_other');
        if (businessNatureSelect.value === 'other') {
