    ...
    <script>
        ...
        function validateForm(event) {
            const requiredFields = [
                ...
                'dateOrganized', 'dateCBLRatification', 'placeOperation', 'maleCount', 'femaleCount', 'occupation'
            ];
            let isValid = true;
...
<body>
    <div class="header">
        <a href="admin.php" class="back-link" style="position: absolute; top: 10px; left: 10px; text-decoration: none; font-size: 16px;">
            <img src="back.png" alt="Back to Home" width="20" height="20" style="vertical-align: middle;"> Back to Home
        </a>
    ...
    <div class="container">
        <div class="main-content">
            <form name="registrationForm" action="submit.php" method="post" enctype="multipart/form-data" onsubmit="validateForm(event)">
                <table boarder="1" width="100%" cellspacing="20px">
                    ...
                    <tr>
                        ...
                        <b><div class="header">Name of Applicant Association</div><br/></b>
                            <label>Name</label><br/>
                            <input class="myInput-right" type="text" name="name"/><br/>
                            <label>Address</label><br/>
                            <input class="myInput-right" type="text" name="address"/>    
                        </td>
                        <td valign="top">
                            <b><div class="header">Contact Nos.</div><br/></b>
                            <label>E-Mail:</label><br/>
                            <input class="myInput-left" type="text" name="email"/><br/>
                            <label>Landline No:</label><br/>
                            <input class="myInput-left" type="text" name="landline"/><br/>
                            <label>Mobile No:</label><br/>
                            <input class="myInput-left" type="text" name="mobile"/><br/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"><hr/></td>
                    ...
                    <tr>
                        <td width="75%" valign="top">
                            ...
                            <input class="myInput-right" type="text" name="firstName"/><br/>
                            <label>(Middle Name)</label><br/>
                            <input class="myInput-right" type="text" name="middleName"/><br/>
                            <label>(Last Name)</label><br/>
                            <input class="myInput-right" type="text" name="lastName"/><br/>
                            <label>Address</label><br/>
                            <input class="myInput-right" type="text" name="address"/><br/>
                            <label for="gender">Gender:</label><br/>
                            <select id="gender" name="gender" style="width: 30%; height: 45px;">
                    ...
                    <tr>
                        ...
                        <b><div class="header">Date Organized<br/></div><br/></b>
                            <input type="date" id="dateOrganized" name="dateOrganized" style="width: 35%; height: 37px;">
                        </td>
                        <td valign="top">
                        <b><div class="header">Date of CBL Ratification</div><br/></b>
                            <input type="date" id="dateCBLRatification" name="dateCBLRatification" style="width: 40%; height: 37px;">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"><hr/></td>
                    ...
                    <tr>
                        <td width="70%" valign="top">
                           <b><div class="header">Place of Operations</div><br/></b>
                            <textarea class="textArea" name="placeOperation">Input Here!!!</textarea>
                            <br/>
                        </td>
                        <td valign="top">
                            <b><div class="header">No. of Association Members </div></b><br/>
                            <label>Male</label><br/>
                            <input class="myInput-left" type="number" id="maleCount" name="no_of_male" min="0" oninput="calculateTotal()"/><br/>
                            <label>Female</label><br/>
                            <input class="myInput-left" type="number" id="femaleCount" name="no_of_female" min="0" oninput="calculateTotal()"/><br/>
                    ...
                    <tr>
                        ...
                        <b><div class="header">Occupation of Members:</div><br/></b>
                            <div class="occupation-checkboxes" style="border: 1px solid #ccc; padding: 10px; border-radius: 5px;">
                                <label><input type="radio" name="occupation" value="agricultural"> Agricultural Workers (Farmers)</label><br/>
